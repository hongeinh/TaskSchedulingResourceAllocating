...
//	public ArrayList<Double> calculateResourceAndStart(List<Resource> requiredResources, List<Resource> assignedResources, List<Integer> assignedResourceVariable, List<Integer> assignedResourceOrder) {
//		ArrayList<Double> resourcesTasksOrdersAndStart = new ArrayList<>();
//		double minStart = Double.MAX_VALUE;
//
//		ArrayList<Resource> availableResources = getAvailableResources(requiredResou, assignedResources);
//
